...
#### We can take math as an example

We cam try to use criteria-based procedures, automatic search procedures, and shrink methods to test whether the best model contains the other two test scores we select in every method we use, 
```{r}
X_math2 <- model_data %>%
  select(-math_score)  
